...
5. Always use the software-engineering (.claude/skills/software-engineering) and use typescript (.claude/skills/typescript) skill for code principle and conventions.
6. For frontend tasks, if the project use react/next, use react (.claude/skills/react) skill, for all UI always consult DESYGN-SYSTEM.md to understand all concepts of design system.
